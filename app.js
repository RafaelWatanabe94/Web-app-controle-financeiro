...
function cadastrarDespesa(){
  ...
  if(despesa.validarDados()){
    ...
    bd.gravar(despesa)
     ...
     document.getElementById('modal-texto').innerHTML = 'Despesa foi cadastrada com sucesso'
     ...
     document.getElementById('modal-texto').innerHTML = 'Erro na gravação do registro'
